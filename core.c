...
struct mCoreCallbacks* mCorePythonCallbackCreate(void* pyobj) {
	...
	callbacks->shutdown = _mCorePythonCallbacksShutdown;
	callbacks->keysRead = _mCorePythonCallbacksKeysRead;
	callbacks->savedataUpdated = _mCorePythonCallbacksSavedataUpdated;
	callbacks->alarm = _mCorePythonCallbacksAlarm;
